...
pc_backend/installer/   Windows tray app and ZIP package source
...
pc_backend/installer/   Windows 托盘程序和 ZIP 安装包源码
...
从 GitHub Release 下载 `SciToday-PC-Backend-V1.0.1.zip`，解压后运行：
